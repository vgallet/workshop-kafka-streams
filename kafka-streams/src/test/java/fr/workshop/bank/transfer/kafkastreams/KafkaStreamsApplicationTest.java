...
import static fr.workshop.bank.transfer.kafkastreams.KafkaStreamsApplication.ALERT_HUGE_AMOUNT_TOPIC;
...
class KafkaStreamsApplicationTest {
    ...
    public void should_filter_huge_amount() {
        ...
        final Topology topology = KafkaStreamsApplication.createTopology(MOCK_SCHEMA_REGISTRY_URL);
        final Properties streamsConfiguration = KafkaStreamsApplication.configuration();
        ...
        try (final TopologyTestDriver topologyTestDriver = new TopologyTestDriver(topology, streamsConfiguration)) {
            ...
            final TestInputTopic<String, BankTransfer> input = topologyTestDriver
                    .createInputTopic(KafkaStreamsApplication.BANK_TRANSFER_TOPIC,
